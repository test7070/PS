	...
	<head>
		...
		<script type="text/javascript">
			...
			function mainPost() {// 載入資料完，未 refresh 前
				...
				q_cmbParse("cmbStype", '1@買賣,2@代工,5@外銷');
			...
			function btnOk() {
				...
				/*if ($('#txtDatea').val().substring(0, 3) != r_accy) {   1034
			...
			function btnPrint() {
				q_box("z_vccp_ps.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";noa=" + $('#txtNoa').val() + ";" + r_accy, 'z_vccstp', "95%", "95%", q_getMsg('popPrint'));
			}
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs' style=' text-align:center'>
				<tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:30px;"><a id='lblProductno_s'> </a></td>
					<td align="center" style="width:15px;"><a id='lblStyle_st'> </a></td>
					<td align="center" style="width:80px;"><a id='lblProduct_st'> </a></td>
					<td align="center" style="width:30px;"><a>板面</a></td>
					<td align="center" style="width:50px;"><a>厚度</a></td>
					<td align="center" style="width:50px;"><a>寬度/OD</a></td>
					<td align="center" style="width:50px;"><a>長度/ID</a></td>
					<td align="center" style="width:50px;"><a>寬度2</a></td>
					...
					<td align="center" style="width:80px;"><a>貨單重量</a></td>
					<td align="center" style="width:80px;"><a>實際單價</a></td>
					<td align="center" style="width:30px;"><a id='lblUnit'> </a></td>
					<td align="center" style="width:80px;"><a id='lblTotal_s'> </a></td>
					<td align="center" style="width:100px;"><a>爐號</a></td>
					<td align="center" style="width:70px;"><a id='lblGweight'> </a></td>
